...
<Figure>
  <img slot="figure" src="/images/fig1_teaser.png" alt="REAL framework teaser: robot performing parkour with nominal vision and under severe visual degradation" class="rounded-lg w-full" />
...
<Wide>
<Figure>
  <img slot="figure" src="/images/fig2_architecture.png" alt="System architecture of REAL" class="rounded-lg w-full" />
...
<Figure>
  <img slot="figure" src="/images/fig3_terrains.png" alt="Snapshots of REAL policy executing dynamic maneuvers across extreme terrains" class="rounded-lg w-full" />
...
<Wide>
<Figure>
  <img slot="figure" src="/images/fig4_blindzone.png" alt="Simulation results on complex parkour terrains with a 1m vision-masked blind zone" class="rounded-lg w-full" />
...
<Figure>
  <img slot="figure" src="/images/fig6_realworld.png" alt="Zero-shot sim-to-real transfer of REAL on a Unitree Go2 quadruped" class="rounded-lg w-full" />
  ...
  <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
    <div class="bg-white rounded-lg shadow-md overflow-hidden dark:bg-zinc-800">
      <video controls muted playsinline preload="auto" class="w-full">
        <source src="/play_videos_baseline_depth_blindzone/play-parkour_flat-L0-1.mp4" type="video/mp4" />
      </video>
      <div class="p-4">
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden dark:bg-zinc-800">
      <video controls muted playsinline preload="auto" class="w-full">
        <source src="/play_videos_baseline_depth_blindzone/play-parkour_hurdle-L0-1.mp4" type="video/mp4" />
      </video>
      <div class="p-4">
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden dark:bg-zinc-800">
      <video controls muted playsinline preload="auto" class="w-full">
        <source src="/play_videos_baseline_depth_blindzone/play-parkour_step-L0-1_baseline.mp4" type="video/mp4" />
      </video>
      <div class="p-4">
...
<div class="not-prose my-8">
  ...
  <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
    <div class="bg-white rounded-lg shadow-md overflow-hidden dark:bg-zinc-800">
      <video controls muted playsinline preload="auto" class="w-full">
        <source src="/play_videos_ours_depth_blindzone/ours_flat_blind_test.mp4" type="video/mp4" />
      </video>
      <div class="p-4">
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden dark:bg-zinc-800">
      <video controls muted playsinline preload="auto" class="w-full">
        <source src="/play_videos_ours_depth_blindzone/Ours_hurdle_blind_test.mp4" type="video/mp4" />
      </video>
      <div class="p-4">
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden dark:bg-zinc-800">
      <video controls muted playsinline preload="auto" class="w-full">
        <source src="/play_videos_ours_depth_blindzone/Ours_step_blind_test.mp4" type="video/mp4" />
      </video>
      <div class="p-4">
...
<Figure>
  <img slot="figure" src="/images/fig7_latency.png" alt="Onboard inference latency comparison between REAL (Mamba) and Transformer baseline" class="rounded-lg w-full" />
...
<Figure>
  <img slot="figure" src="/images/fig8_convergence.png" alt="Training convergence comparison" class="rounded-lg w-full" />
